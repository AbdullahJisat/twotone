...
<!-- Mirrored from themesbrand.com/skote/layouts/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Jul 2022 09:38:47 GMT -->
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" action="{{ route('user.login') }}" method="POST">
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <a class="text-muted" href="#"><i class="mdi mdi-lock me-1"></i>
